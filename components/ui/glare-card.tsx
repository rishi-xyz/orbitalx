...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-&lsqb;var(--duration)&rsqb; ease-&lsqb;var(--easing)&rsqb; delay-&lsqb;var(--delay)&rsqb; will-change-transform w-full h-[150px] [aspect-ratio:16/20]"
      ref={refElement}
      onPointerMove={(event) => {
